...
// FIXME:
// hcsshim is pinned until the transitive dependency to containerd v1.7 is resolved
// https://github.com/microsoft/hcsshim/pull/2293/files
replace github.com/Microsoft/hcsshim => github.com/Microsoft/hcsshim v0.12.7

// FIXME:
// plugins are pinned until they restore support for golang 1.22
replace github.com/containernetworking/plugins => github.com/containernetworking/plugins v1.5.1
