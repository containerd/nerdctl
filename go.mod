...
require (
	...
	github.com/containerd/accelerated-container-image v1.4.0
	...
	github.com/docker/cli v29.1.4+incompatible //gomodjail:unconfined
	...
	golang.org/x/term v0.39.0 //gomodjail:unconfined
