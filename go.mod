...
require (
	...
	github.com/containerd/nydus-snapshotter v0.15.4 //gomodjail:unconfined
	...
	github.com/docker/cli v28.5.0+incompatible //gomodjail:unconfined
	github.com/docker/docker v28.5.0+incompatible //gomodjail:unconfined
