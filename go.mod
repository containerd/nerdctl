...
require (
	...
	github.com/compose-spec/compose-go/v2 v2.13.0 //gomodjail:unconfined
	...
	github.com/containerd/containerd/v2 v2.3.2 //gomodjail:unconfined
	...
	github.com/docker/cli v29.6.1+incompatible //gomodjail:unconfined
