...
func imageInspectAction(cmd *cobra.Command, args []string) error {
	...
	return InspectActionWithPlatform(cmd, args, platform)
}

func InspectActionWithPlatform(cmd *cobra.Command, args []string, platform string) error {
	...
	return fmtutil.FormatSlice(cmd, f.entries)
}
