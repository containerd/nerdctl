...
func TestWait(t *testing.T) {
	...
	testCase.Setup = func(data test.Data, helpers test.Helpers) {
		...
		helpers.Ensure("run", "-d", "--name", data.Identifier("2"), testutil.CommonImage, "sleep", "0.1")
		helpers.Ensure("run", "-d", "--name", data.Identifier("3"), testutil.CommonImage, "sh", "-euxc", "sleep 0.5; exit 123")
	}
