...
func NewPruneCommand() *cobra.Command {
	...
	utils.AddStringFlag(buildPruneCommand, "buildkit-host", nil, defaults.BuildKitHost(), "BUILDKIT_HOST", "BuildKit address")
...
func NewDebugCommand() *cobra.Command {
	...
	var buildDebugCommand = &cobra.Command{
		Use:           "debug",
		Short:         shortHelp,
		PreRunE:       utils.CheckExperimental("`nerdctl builder debug`"),
