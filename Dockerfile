...
ARG CONTAINERD_VERSION=v2.4.0-beta.0@58e6cee9dee67ee87ee2f727d3570009050f9954
ARG RUNC_VERSION=v1.5.1@8f2685a471d3347a686ad3909783d8aafc6bb208
ARG CNI_PLUGINS_VERSION=v1.9.1@BINARY

# Extra deps: Build
ARG BUILDKIT_VERSION=v0.33.0@BINARY
# Extra deps: Lazy-pulling
ARG STARGZ_SNAPSHOTTER_VERSION=v0.18.2@BINARY
# Extra deps: Encryption
ARG IMGCRYPT_VERSION=v2.0.3@3cd28929043ba2847633c32b806a6ccda8cd030f
# Extra deps: Rootless
ARG ROOTLESSKIT_VERSION=v3.2.0-beta.0@BINARY
# Extra deps: bypass4netns
ARG BYPASS4NETNS_VERSION=v0.4.2@aa04bd3dcc48c6dae6d7327ba219bda8fe2a4634
# Extra deps: FUSE-OverlayFS
ARG FUSE_OVERLAYFS_VERSION=v1.18@BINARY
...
ARG SOCI_SNAPSHOTTER_VERSION=0.15.0
