...
// Package annotations provides a high-level interface to retreive and manipulate container OCI annotations.
...
// we can evolve the storage format in one place and consuming code to be fully isolated from the details of
// how it is being handled.
// Container annotations generally should be used to store state information or other container property that
