...
func ZstdConvertOpt(options types.ZstdOptions) (converter.Opt, error) {
	convertFunc, err := ZstdLayerConvertFunc(options)
	if err != nil {
		return nil, err
	}
...
func ZstdLayerConvertFunc(options types.ZstdOptions) (converter.ConvertFunc, error) {
