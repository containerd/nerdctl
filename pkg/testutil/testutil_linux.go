...
var (
	...
	BusyboxImage        = getImage("ghcr.io/containerd/busybox")
	...
	MariaDBImage        = getImage("ghcr.io/stargz-containers/mariadb")
	NginxAlpineImage    = getImage("ghcr.io/stargz-containers/nginx")
	RegistryImageStable = getImage("ghcr.io/distribution/distribution")
	SystemdImage        = getImage("ghcr.io/containerd/stargz-snapshotter")
	WordpressImage      = getImage("ghcr.io/stargz-containers/wordpress")

	CommonImage = AlpineImage

	FedoraESGZImage = getImage("ghcr.io/stargz-containers/fedora")             // eStargz
	FfmpegSociImage = getImage("public.ecr.aws/soci-workshop-examples/ffmpeg") // SOCI
	UbuntuImage     = getImage("public.ecr.aws/docker/library/ubuntu:23.10")   // Large enough for testing soci index creation
)
