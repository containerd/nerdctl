...
func Binary(name string) *Requirement {
	return &Requirement{
		Check: func(data Data, helpers Helpers, t *testing.T) (bool, string) {
...
// NOTE: nested Not will loose setups and cleanups...
func Not(requirement *Requirement) *Requirement {
	return &Requirement{
		Check: func(data Data, helpers Helpers, t *testing.T) (bool, string) {
			ret, mess := requirement.Check(data, helpers, t)
			return !ret, mess
		},
	}
}
	...
	return &Requirement{
		Check: func(data Data, helpers Helpers, t *testing.T) (bool, string) {
			...
			for _, requirement := range requirements {
				ret, subMess = requirement.Check(data, helpers, t)
				mess += subMess
				if !ret {
					return ret, mess
				}
