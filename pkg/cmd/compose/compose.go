...
func GetComposer(options *composer.Options, client *containerd.Client, volStore volumestore.VolumeStore, stdout, stderr io.Writer, globalOptions *types.GlobalCommandOptions) (*composer.Composer, error) {
	var err error
