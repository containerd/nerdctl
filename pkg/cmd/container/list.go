...
func List(ctx context.Context, client *containerd.Client, options types.ContainerListOptions) error {
	...
	return printContainers(ctx, client, options, containers, all)
}

func printContainers(ctx context.Context, client *containerd.Client, options types.ContainerListOptions,
	containers []containerd.Container, all bool) error {
