...
func getEstargzConvertFunc(options types.ImageConvertOptions) (converter.ConvertFunc, func(ctx context.Context, cs content.Store, ref string, desc *ocispec.Descriptor) (*images.Image, error), error) {
	return nil, nil, ErrStargzNotImplemented
}

func getESGZConvertOpts(options types.ImageConvertOptions) ([]interface{}, error) {
...
func readPathsFromRecordFile(recordFile string) ([]string, error) {
	return nil, ErrStargzNotImplemented
}